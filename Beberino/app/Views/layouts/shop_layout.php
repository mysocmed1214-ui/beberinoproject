    ...
    <?php if(session()->get('logged_in')): ?>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="fa-solid fa-user"></i> <?= esc(session()->get('user_name')) ?>
            </a>
        </li>
        <li class="nav-item">
...
<section class="hero">
  <div class="container">
    <h1 class="fw-bold"><i class="fa-solid fa-fire-flame-curved"></i> Welcome to Uling Shop</h1>
    <p class="lead">Premium charcoal at your fingertips — sustainable, affordable, and high-quality.</p>
  </div>
</section>
...
<footer>
  <div class="container">
    <p class="mb-0">© <?= date('Y') ?> <i class="fa-solid fa-fire"></i> Uling Shop. All Rights Reserved.</p>
  </div>
</footer>
